...
### macOS
- [**Homebrew**](https://brew.sh/) (recomendado): `brew install python@3.13`
...
- Para explorar el tipado estático en Python desde la óptica de TypeScript: [Guía de TypeScript: De 0 a 100](/posts/guia-0-100-typescript/).
- Para empaquetar tu aplicación en contenedores: [Guía de Docker: De 0 a 100](/posts/guia-0-100-docker/).
- Generación de XML en Python: [Generar XML con Python](/posts/generar_xml_python/).
- Procesamiento de documentos y PDFs: [PDF Ninja](/posts/pdf_ninja/).
