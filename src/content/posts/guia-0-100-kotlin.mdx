...
### VS Code
1. Instala la extensión [**Kotlin**](https://kotlinlang.org/) (de Microsoft, language server vía Kotlin LS)
...
- [**Docker**](https://www.docker.com/) — containeriza tus apps Ktor/Android: [Docker: instalación y primeros pasos](/posts/docker-instalacion-primeros-pasos/)
