...
### Requisitos
- **Node.js 18+** (recomendado [**Node.js 22 LTS**](https://nodejs.org/en/download/) o [20 LTS](https://nodejs.org/en/download/releases/))
- Editor: VSCode con extensión oficial [**Astro**](https://astro.build/)
...
- [Guía de Markdown y MDX: de 0 a 100](/posts/guia-0-100-markdown/) — domina el formato que alimenta las colecciones de contenido de Astro
- [Guía de TypeScript: de 0 a 100](/posts/guia-0-100-typescript/) — tipado estático para componentes y props en Astro
- [Guía de JavaScript: de 0 a 100](/posts/guia-0-100-javascript/) — la base que soporta Islands, server endpoints y cualquier framework moderno
...
- [**GitHub**](https://github.com/): [github.com/withastro/astro](https://github.com/withastro/astro)
