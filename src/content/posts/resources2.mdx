...
<ResourceCard
  ...
  title="OpenWork"
  description="App de escritorio open-source para ejecutar agentes de IA en tus archivos."
  headline="Un Claude Cowork pero de código abierto"
  features={["Usa OpenCode como motor", "Compatible con +50 modelos", "Accede a tus archivos Excel, Word, PDF y más", "Bring your own keys (BYOK)"]}
  platform="macOS, Windows y Linux"
/>

<ResourceCard
  href="https://pixelrag.ai"
  title="PixelRAG"
  description="Visual RAG from UC Berkeley. Searches documents by how they look, not just text."
  headline="Busca documentos por cómo se ven, no solo por el texto"
  features={["Indexa 8.28M páginas como tiles visuales", "Consultas de texto e imagen con Qwen3-VL", "Plugin Claude Code para navegación visual", "Apache-2.0, auto-hospedable con FAISS"]}
  platform="macOS, Windows, Linux, Web, CLI"
/>

<ResourceCard
  href="https://www.midjourney.com/"
  title="Midjourney"
  description="Generador de imágenes con IA, líder en calidad artística."
  headline="El generador de imágenes con mejor calidad artística"
  features={["Motor v7/v8 con fotorrealismo", "Estilos personalizados y remezcla", "Editor de imágenes integrado", "Comunidad activa de artistas"]}
  platform="Navegador web, Discord"
/>

<ResourceCard
  href="https://blackforestlabs.ai/"
  title="Flux AI"
  description="El mejor generador de imágenes open-source (Black Forest Labs)."
  headline="La mejor opción open-source para generación de imágenes"
  features={["Modelos Flux 1.1 y 2.0", "12B parámetros, fotorrealismo extremo", "Soporte ControlNet y IP-Adapter", "Licencia Apache-2.0"]}
  platform="Local, API, Navegador"
/>

<ResourceCard
  href="https://ideogram.ai/"
  title="Ideogram"
  description="Generador de imágenes con el mejor renderizado de texto."
  headline="Genera imágenes con texto perfecto dentro"
  features={["Renderizado de texto preciso en imágenes", "Estilos múltiples (fotorrealista, ilustración, 3D)", "Editor de imagen con IA", "API disponible"]}
...
<ResourceCard
  ...
  title="Leonardo AI"
  description="IA para arte de juegos y concept art con modelos especializados."
  headline="La IA definitiva para artistas de juegos"
  features={["Modelos especializados en game art", "Generación de texturas y sprites", "Canvas editor con IA", "Entrenamiento de modelos propios"]}
  platform="Navegador web"
/>
...
<ResourceCard
  ...
  title="Krea"
  description="Generador de imágenes con edición en tiempo real y transferencia de estilo."
  headline="Edición de imágenes con IA en tiempo real"
  features={["Generación en vivo mientras dibujas", "Transferencia de estilo avanzada", "Upscaling y enhance con IA", "Múltiples motores de IA"]}
  platform="Navegador web"
/>
...
<ResourceCard
  ...
  title="Recraft"
  description="Generador de imágenes vectoriales y diseños con IA."
  headline="IA para generar imágenes vectoriales y diseños"
  features={["Genera SVG directamente con IA", "Estilo de marca consistente", "Eliminación de fondo automática", "Exporta a Figma y herramientas de diseño"]}
  platform="Navegador web"
/>
...
<ResourceCard
  ...
  title="ComfyUI"
  description="Interfaz nodal open-source para Stable Diffusion con workflows personalizables."
  headline="Control total sobre la generación de imágenes con nodos"
  features={["Workflows personalizables con nodos", "Soporte multi-modelo (SD, Flux, etc)", "Ejecución en paralelo", "Miles de nodos de la comunidad"]}
...
<ResourceCard
  ...
  title="Fooocus"
  description="Generador de imágenes open-source optimizado para facilitar Stable Diffusion."
  headline="Stable Diffusion sin complicaciones"
  features={["Interfaz ultra simple, solo prompt y botón", "Optimizado para calidad sin configuración", "Inpainting y outpainting integrado", "Soporte ControlNet básico"]}
  platform="macOS, Windows, Linux"
/>

<ResourceCard
  href="https://openai.com/index/introducing-gpt-image-1/"
  title="GPT Image (DALL-E)"
  description="Generador de imágenes integrado en ChatGPT con mejor renderizado de texto."
  headline="Genera imágenes directamente en ChatGPT"
  features={["Integrado en ChatGPT Plus/Pro", "Renderizado de texto preciso", "Edición conversacional", "API para desarrolladores"]}
  platform="Navegador web, API"
/>

<ResourceCard
  href="https://firefly.adobe.com/"
  title="Adobe Firefly"
  description="IA generativa entrenada con contenido con licencia, integrada en Creative Cloud."
  headline="IA generativa segura para uso comercial"
  features={["Entrenada con contenido con licencia", "Integrada en Photoshop e Illustrator", "Generación de texto y recolor", "Commercially safe"]}
  platform="Navegador web, Desktop (Creative Cloud)"
/>

<ResourceCard
  href="https://github.com/nicepkg/open-pencil"
  title="OpenPencil"
  description="Editor de diseño AI-native open-source, alternativa a Figma."
  headline="Figma pero con IA integrada de serie"
  features={["Genera componentes con IA", "Auto-layout inteligente", "Exporta a código React/Vue", "Colaboración en tiempo real"]}
  platform="macOS, Windows, Linux"
/>
...
<ResourceCard
  ...
  title="Perplexity AI"
  description="Búsqueda con IA que cita sus fuentes."
  headline="Google pero con respuestas de IA y fuentes citadas"
  features={["Respuestas con citas verificadas", "Modo Pro con modelos avanzados", "Búsqueda en tiempo real", "Colecciones de investigación"]}
  platform="Navegador web, iOS, Android"
/>

<ResourceCard
  href="https://ollama.com/"
  title="Ollama"
  description="Ejecuta modelos de lenguaje localmente en tu máquina."
  headline="LLMs en tu ordenador sin depender de la nube"
  features={["+100 modelos disponibles", "Una línea de comando para ejecutar", "API compatible con OpenAI", "GPU y CPU soportados"]}
  platform="macOS, Windows, Linux"
/>
...
<ResourceCard
  ...
  title="LM Studio"
  description="Inferencia de LLMs local con interfaz gráfica."
  headline="Interfaz gráfica para ejecutar LLMs localmente"
  features={["Descarga modelos con un clic", "Chat UI y servidor local", "Soporte GPU acelerado", "Compatible con OpenAI API"]}
  platform="macOS, Windows, Linux"
/>
