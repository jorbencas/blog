...
Nacido como **Mocha**, luego **LiveScript** y finalmente [**JavaScript**](https://developer.mozilla.org/en-US/docs/Web/JavaScript), en 1997 se estandarizó como **ECMAScript** (ES). Desde ES6 (2015) el lenguaje ha evolucionado enormemente con clases, promesas, módulos, y más.
...
- [**ESLint**](https://eslint.org/) (Microsoft) — linting de JS/TS
- [**Prettier**](https://prettier.io/) (Prettier) — formateador automático
...
|---|---|---|---|
| [**Prisma**](https://www.prisma.io/) | ✅ | ✅ | ORM moderno, schema declarativo, migrations |
...
| [**Jest**](https://jestjs.io/) | Unitario, integración, mocks | ✅ | `npx jest` |
| [**Playwright**](https://playwright.dev/) | E2E (navegador) | ✅ | `npx playwright test` |
...
- [**Astro**](https://astro.build/): islas de interactividad (server-first)
...
### Hosting
- [Vercel](https://vercel.com/) — despliegue desde GitHub con cero configuración
- [Netlify](https://www.netlify.com/) — integración continua con tu repo
- [Railway](https://railway.app/) — conecta el repo y despliega al instante
...
- [Guía de TypeScript: de 0 a 100](/posts/guia-0-100-typescript/) — añade tipado estático a tu JavaScript para evitar muchos de estos errores en tiempo de compilación
- [Guía de Astro: de 0 a 100](/posts/guia-0-100-astro/) — usa JavaScript en la práctica con componentes, SSR e Islands
- [Guía de Markdown y MDX: de 0 a 100](/posts/guia-0-100-markdown/) — entiende el formato base de la mayoría de documentaciones y blogs modernos
