...
* **Proyecto (El Extractor de Albaranes):** Toda la infraestructura se aísla en contenedores. El bot recibe la foto de un albarán, la IA extrae los datos y el backend los almacena en una base de datos NoSQL ([**MongoDB**](https://www.mongodb.com/)) para auditoría y validación humana si el OCR falla.
