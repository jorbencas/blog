...
* **El Proyecto:** Usando **Docker Compose**, levantas tres contenedores que trabajan en equipo:
  ...
  2. **Contenedor B (La Base de Datos):** Un contenedor de [**MongoDB**](https://www.mongodb.com/).
...
* **El Proyecto (Proyecto Grande #1):** El flujo completo que querías entender:
  ...
  4. Tu backend valida los datos. Si todo cuadra, guarda el JSON en [**MongoDB**](https://www.mongodb.com/) con el estado `procesado` y **el Bot le responde al usuario automáticamente**: *"✅ Albarán #4502 registrado correctamente. 12 cajas añadidas al inventario"*.
...
* **El Proyecto (Gran Plataforma SaaS):** 
  ...
  * Guarda el histórico de los chats y logs en [**MongoDB**](https://www.mongodb.com/).
