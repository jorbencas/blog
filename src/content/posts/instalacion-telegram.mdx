...
> 🔗 Este ciclo es el **consumidor final** del pipeline del [Ecosistema Devjobs](/posts/instalacion-devjobs#135-flujo-del-pipeline-1--directo--telegram-sendosama): los `*_compressed.mp4` los produce el **monitor de FFmpeg** ([ciclo de compresión](/posts/instalacion-ffmpeg#91-el-ciclo-de-compresión-paso-a-paso)).
