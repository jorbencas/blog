...
let img = image::open("foto.png")?;
println!("{}x{}", img.width(), img.height());

// Redimensionar
let redimensionada = img.resize(800, 600, image::imageops::FilterType::Lanczos3);
...
#### ✅ Buenas prácticas
- ✅ Usa `image::open` para cargar cualquier formato soportado
