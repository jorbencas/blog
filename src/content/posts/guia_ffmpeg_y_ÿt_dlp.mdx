...
Anteriormente vimos cómo usar **ffmpeg** para fusionar videoclases con su pista de audio en el post [Scripts Bash — Unir Video y Audio](/posts/scripts/). Allí recorríamos carpetas de videos, buscábamos el audio correspondiente por número de tema y ejecutábamos ffmpeg para combinarlos. Aquí ampliamos con más casos de uso: cambiar codecs de audio, cortar fragmentos, concatenar videos, convertir lotes y descargar streams con yt-dlp.
