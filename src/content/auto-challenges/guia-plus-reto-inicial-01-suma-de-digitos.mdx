...
description: "Dado un número entero positivo, suma todos sus dígitos. Por ejemplo: 1234 → 1+2+3+4 = 10."
pubDate: "2026-03-29"
...
<Challenge 
  nivel="Iniciación" 
  mision="Dado un número entero positivo, suma todos sus dígitos. Por ejemplo: 1234 → 1+2+3+4 = 10." 
/>
