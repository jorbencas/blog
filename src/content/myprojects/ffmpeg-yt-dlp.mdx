...
### Para el pipeline de compresión automática

```bash
# Arrancar el monitor (vigila carpetas y comprime)
...
```bash
# En Windows/WSL, arrancar el watcher para abrir vídeos en VLC
bash preview_watcher.sh --daemon
